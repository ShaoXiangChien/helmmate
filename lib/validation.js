...
import { CODEX_BIN, REPO_KEYS, SCRIPTS_PROMPT, STATUSES, WORK_PROMPT_REF, WORKSPACE_DIR } from "./paths.js";
import { resolveEngine } from "./engine.js";
import { agentFileExists, agentFilePath, CODEX_EFFORTS, CODEX_MODELS, resolveRole } from "./roles.js";
...
export function launchPreflight(ticket, options = {}) {
  ...
  if (!agentFileExists(role)) {
    const fallback =
      engine === "codex"
        ? "Codex will run without a persona preamble"
